...
const MovieGrid = () => {
    ...
    return (_jsxs("div", { className: styles.movieGridContainer, children: [_jsx("div", { className: styles.row, children: row1.map((url, index) => (_jsx("img", { src: url, alt: "", className: styles.movieItem }, `row1-${index}`))) }), _jsx("div", { className: styles.row, children: row2.map((url, index) => (_jsx("img", { src: url, alt: "", className: styles.movieItem }, `row2-${index}`))) }), _jsx("div", { className: styles.row, children: row3.map((url, index) => (_jsx("img", { src: url, alt: "", className: styles.movieItem }, `row3-${index}`))) }), _jsx("div", { className: styles.row, children: row4.map((url, index) => (_jsx("img", { src: url, alt: "", className: styles.movieItem }, `row4-${index}`))) })] }));
};
