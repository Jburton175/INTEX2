...
// // Helper function to build an image URL using the movie title.
...
// // Extract genres from the URL query parameters.
...
// // Convert an API movie to our Movie object, including its genres.
...
//   // Initialize selected genres from the URL so filter state is preserved on reload.
//   const [selectedGenres, setSelectedGenres] = useState<string[]>(getGenresFromQuery());

//   // Add a state variable for the selected movie id.
...
//   // Validate movie image by doing a HEAD request.
...
//   // Fetch movies on page or filter change.
//   useEffect(() => {
//     fetchMovies(currentPage);
//   }, [currentPage, fetchMovies]);

//   // Handle image errors by adding to a replacement queue.
...
//   // Validate images for all movies.
//   useEffect(() => {
...
//   // Perform client-side filtering if needed.
...
//       <CookieConsentBanner />
//       {/* Genre filter receives the current filter state */}
//       <GenreFilter 
